...
/*
 * This chat is displayed when there are no real conversations yet
...
/*
 * Later, your Rust backend must provide a Tauri command named "get_chats".
 *
 * It must return data shaped like this:
 *
 * [
 *   {
 *     id: 1,
...
async function loadChats() {
  ...
  try {
    ...
    /*
     * Replace the default chat only when real chats exist.
     * If the backend returns an empty array, the default remains.
     */
    ...
    /*
     * The default chat remains visible when the backend command
     * does not exist yet or an error occurs.
     */
    loadError.value = "Backend conversations are currently unavailable.";
  } finally {
